...
import { defaultChangepasswordForm, IChangePasswordForm } from "../../types";
...
export default function ChangePassword() {
  ...
  const onSubmit = async (data: IChangePasswordForm) => {
    ...
    if (captchaRef.current) {
      ...
      debugger;
      changePassword(data, captchaKey)
    ...
    >
      <Paper sx={{ p: 4, pt: 1, width: 360 }} className="">
        <div className="text-center flex justify-center mt-3">
          <LockResetIcon
            className="size-20 mr-2 flex text-9xl"
            sx={{ fontSize: "6rem" }}
            fontWeight={10}
          />
        </div>
        ...
        >
            ...
            <Controller
              ...
              rules={{
                pattern: {
                  ...
                  message:
                    "كلمه عبور باید شامل حروف بزرگ، کوچک، عدد و کاراکتر ویژه باشد",
                },
          ...
          <div
            className="grid col-span-10 col-start-2 h-11 bg-gray-50"
            dir="ltr"
          >
